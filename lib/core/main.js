 ...
 * @param {boolean} [options.getHtml] - Get HTML of the page
 * @param {object} [options.httpAgent] - HTTP agent
 *
...
async function search(query, options = {}) {
    ...
    options.getHtml = options.getHtml || false;
    options.httpAgent = options.httpAgent || null;
  ...
  const url = encodeURI(options.ris &&
    ...
    const results = {
        ...
        local_businesses      : [],
        html                  : options.getHtml ? response.data : null
    };
